...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    total, pig_out, current_roll = 0, False, 0
    while num_rolls > 0:
        current_roll = dice()
        num_rolls -= 1
        total += current_roll
...
def free_bacon(score):
    ...
    digit_difference = 0
    while score > 0:
        digit_difference = score % 10 - digit_difference
        score = score // 10
    return 2 + abs(digit_difference)
    # END PROBLEM 2
...
def is_swap(score0, score1):
    ...
    if score0 <= 1 or score1 <= 1:
        return False
    elif score1 % score0 == 0 or score0 % score1 == 0:
        return True
    else:
        return False
    # END PROBLEM 4
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    # BEGIN PROBLEM 7
    def say(score0, score1):
        high, score = previous_high, previous_score
        if who == 0:
            player_score = score0
        else:
            player_score = score1
        if high < player_score - score:
            high = player_score - score
            if high == 1:
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    """
    # BEGIN PROBLEM 9
    high_score, high_roll = 0, 0
    for roll in range(1, 11):
        averaged = make_averaged(roll_dice, num_samples)(roll, dice)
        if high_score < averaged:
            high_score = averaged
            high_roll = roll
    return high_roll
    # END PROBLEM 9
